...
| Three.js office: two themes, activity zones, minimap, follow camera, reduced motion, graphics presets, 2D fallback  | Working, event-driven, all assets generated locally                                                                                                                                                                                                                   |
...
| Unit, integration, and Chrome browser tests                                                                         | Working: `node --test` 401 tests, Playwright 19 tests ([docs/TESTING.md](docs/TESTING.md))                                                                                                                                                                            |
