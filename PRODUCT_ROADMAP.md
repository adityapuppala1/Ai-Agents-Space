...
Current foundation: React/Three.js office, six fixed demo roles, in-memory tasks, manual lifecycle controls, and WebSocket snapshots. The current application does not execute provider tasks. Retain this demo as a clearly isolated showcase.
